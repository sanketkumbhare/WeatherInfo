package com.sanketkumbhare.weatherinfo.adapter;
...
import com.sanketkumbhare.weatherinfo.activities.MainActivity;
import com.sanketkumbhare.weatherinfo.model.Weather;
import com.sanketkumbhare.weatherinfo.model.WeatherViewHolder;
...
public class WeatherRecyclerAdapter extends RecyclerView.Adapter<WeatherViewHolder> {
    private List<Weather> mItemList;
    ...
    public void onBindViewHolder(WeatherViewHolder customViewHolder, int i) {
        Weather weatherItem = mItemList.get(i);
